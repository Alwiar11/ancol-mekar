    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 bg-gradient ml-1">
                <div class="col-sm-6">
                    <h1 class="m-0 gradient-background mt-2 mb-2 text-light">Detail Kematian</h1>
                </div>
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="#">Daftar Kematian</a></li>
                        <li class="breadcrumb-item active">Detail Kematian</li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="biodata">
                                    <dl class="row">
                                        ...
                                        <dt class="col-sm-3">NIK Kematian</dt>
                                        ...
                                        <dd class="col-sm-9">contoh alamat</dd>

                                        <dt class="col-sm-3">Anak ke</dt>
                                        <dd class="col-sm-9">1</dd>

                                        <dt class="col-sm-3">Tanggal Kematian</dt>
                                        <dd class="col-sm-9">1 Januari 2030</dd>

                                        <dt class="col-sm-3">Sebab Kematian</dt>
                                        <dd class="col-sm-9">Sakit</dd>

                                        <dt class="col-sm-3">Tempat Kematian</dt>
                                        <dd class="col-sm-9">Bandung</dd>
